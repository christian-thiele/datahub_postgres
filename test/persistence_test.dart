...
void main() {
  TestHost(
    ...
    group('Test Schema', () {
      ...
      host.test('Filter equals', () async {
        final repo = resolve<CRUDRepository<TestObject, int>>();
        await _populate(repo);
        expect(
            await repo.count(
                filter: TestObjectDataBean.string.equals('string')),
            1);
        expect(
            await repo.count(filter: TestObjectDataBean.string.equals(1)), 0);
        expect(
            await repo.count(filter: TestObjectDataBean.string.equals('test')),
            1);
        expect(
            await repo.count(
                filter: TestObjectDataBean.string.equals('test22')),
            0);
        expect(
            await repo.count(filter: TestObjectDataBean.boolean.equals(true)),
            1);
        expect(
            await repo.count(filter: TestObjectDataBean.boolean.equals(false)),
            1);
        expect(await repo.count(filter: TestObjectDataBean.intNumber.equals(1)),
            0);
        expect(await repo.count(filter: TestObjectDataBean.intNumber.equals(4)),
            2);
        expect(
            await repo.count(
      ...
      host.test('Filter isIn', () async {
        ...
        expect(
          await repo.count(
              filter: TestObjectDataBean.intNumber.isIn([2, 3, 4])),
          2,
        );
        expect(
          await repo.count(
              filter: TestObjectDataBean.intNumber.isIn([2, 3, 1])),
          0,
        );
        expect(
          await repo.count(
      ...
      host.test('String Array', () async {
        ...
        expect(
            await repo.count(
                filter: ValueExpression('blablubb')
                    .isIn(StringArrayDataBean.values)),
            0);
